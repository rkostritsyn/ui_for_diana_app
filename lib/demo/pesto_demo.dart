...
const List<Recipe> kPestoRecipes = <Recipe>[
  Recipe(
    ...
    imagePath: 'images/roasted_chicken.png',
  ...
  Recipe(
    ...
    ingredientsImagePath: 'images/veggie.png',
    ...
    imagePath: 'images/chopped_beet_leaves.png',
    ingredients: <RecipeIngredient>[
  ...
  Recipe(
    ...
    imagePath: 'images/pesto_pasta.png',
    ingredients: <RecipeIngredient>[
  ...
  Recipe(
    ...
    imagePath: 'image/cherry_pie.png',
    ingredients: <RecipeIngredient>[
  ...
  Recipe(
    name: 'Spinach Salad',
    author: 'Peter Carlsson',
    ingredientsImagePath: 'images/spicy.png',
    ...
    imagePath: 'images/spinach_onion_salad.png',
    ingredients: <RecipeIngredient>[
  ...
  Recipe(
    ...
    imagePath: 'images/butternut_squash_soup.png',
    ingredients: <RecipeIngredient>[
  ...
  Recipe(
    name: 'Spanakopita',
    author: 'Trevor Hansen',
    ingredientsImagePath: 'images/quick.png',
    ...
    imagePath: 'images/spanakopita.png',
    ingredients: <RecipeIngredient>[
